// npm run generatePhrase -- -lang=en-US -inputFile=tmp/inputFile.json -outFile=tmp/outFile.json
...
function extractPhrases(lang, inputFile, outputFile) {
  ...
  fs.writeFileSync(outputFile, JSON.stringify(extractedPhrases, null, 2), 'utf8');
...
extractPhrases(options.lang, options.inputFile, options.outFile);
